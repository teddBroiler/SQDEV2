...
public class FilteredList extends Composite {
	...
	private Vector<Image> fImages= new Vector<Image>();
	...
	private final class LabelComparator implements Comparator<Label> {
		private boolean fIgnoreCase;
		...
		public int compare(Label leftLabel, Label rightLabel) {
			int value;
