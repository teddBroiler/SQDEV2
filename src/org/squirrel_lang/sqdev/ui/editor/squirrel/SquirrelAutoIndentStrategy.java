 ...
 */
public class SquirrelAutoIndentStrategy extends DefaultIndentLineAutoEditStrategy {

	public SquirrelAutoIndentStrategy() {
	}
	 ...
	 */
	 protected void smartIndentAfterNewLine(IDocument document, DocumentCommand command) {
		...
		try {
			...
			System.out.println(SquirrelEditorMessages.getString("AutoIndent.error.bad_location_1")); //$NON-NLS-1$
		}
	}
	 ...
	 */
	 protected void smartInsertAfterBracket(IDocument document, DocumentCommand command) {
		...
		try {
			...
			System.out.println(SquirrelEditorMessages.getString("AutoIndent.error.bad_location_2")); //$NON-NLS-1$
		}
	}
}
