 ...
 *******************************************************************************/
package org.squirrel_lang.sqdev.ui.editor.squirreldoc;
 ...
 */
public class SquirreDocScanner extends RuleBasedScanner {
	 ...
	 */
	 public SquirreDocScanner(SquirreColorProvider provider) {
		super();

		/*IToken keyword= new Token(new TextAttribute(provider.getColor(SquirreColorProvider.JAVADOC_KEYWORD)));
		IToken tag= new Token(new TextAttribute(provider.getColor(SquirreColorProvider.JAVADOC_TAG)));
		IToken link= new Token(new TextAttribute(provider.getColor(SquirreColorProvider.JAVADOC_LINK)));
		...
		list.add(new WhitespaceRule(new SquirreWhitespaceDetector()));
